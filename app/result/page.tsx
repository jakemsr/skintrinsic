...
export default function Result() {
  ...
  return (
    <>
      {processing ? (
        <div className="relative h-dvh w-screen overflow-x-hidden overflow-y-hidden flex items-center justify-center text-[#1a1b1c]">
        ...
        cameraCapture ? (
          <>
            <div className="relative h-dvh w-screen overflow-x-hidden overflow-y-hidden flex items-center justify-center text-[#fcfcfc]">
              <Webcam
                audio={false}
                ref={webcamRef}
          ...
          <div className="relative flex flex-col h-dvh w-screen overflow-x-hidden overflow-y-hidden bg-[#fcfcfc] text-[#1a1b1c]">
            ...
            {displayAllowCamera && (
              <div className="absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 xl:left-1/3 xl:translate-x-0 w-88 h-34 font-semibold uppercase bg-[#1a1b1c] text-[#fcfcfc]">
